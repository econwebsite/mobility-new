      ...
      <div className='mainContainer'>
        <div className="ProductBlogs-cards">
          <div className="ProductBlogs-card">
            ...
            <AnimationButton text="Read more" backgroundColor="#344ea1" hoverColor="white"  to="/blog/how-forward-facing-camera-works-in-adas/" className="Blog-readmore-btn" />
          </div>
          <div className="ProductBlogs-card">
            ...
            <AnimationButton text="Read more" backgroundColor="#344ea1" hoverColor="white"  to="/blog/why-hdr-lfm-matter-forward-facing-cameras-adas/" className="Blog-readmore-btn" />
          </div>
          ...
          <div className="ProductBlogs-card">
            ...
            <AnimationButton text="Read more" backgroundColor="#344ea1" hoverColor="white"  to="/blog/how-driver-monitoring-cameras-improve-safety-features/" className="Blog-readmore-btn" />
          </div>
          <div className="ProductBlogs-card">
            ...
            <AnimationButton text="Read more" backgroundColor="#344ea1" hoverColor="white"  to="/blog/how-surround-view-cameras-improve-driving-parking-safety/" className="Blog-readmore-btn" />
          </div>
        </div>
      </div>
    </div>
